...
const CSODashboard = () => {
  ...
  const lateCount = totalAttendance - punctualCount; // Assuming late = incomplete records
  ...
  return (
    <Box sx={{ bgcolor: "#f4f4f4", minHeight: "100vh", p: 3 }}>  {/* ✅ Background Color Added */}
      {/* Summary Cards */}
      <Grid container spacing={3}>
        <Grid item xs={12} sm={4}>
          <Card sx={{ p: 2, backgroundColor: "white", color: "black", textAlign: "center" }}>
            <CardContent>
